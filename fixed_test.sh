...
# Phase 1 starts from random initialization. No checkpoint is shared with siblings.
...
# Phase 2 restores only this run's own phase-1 checkpoint and switches TFRecords.
