...
This branch isolates the five candidate-shop SID values as direct model
features. They enter LR/FM and the shop representation, while SID history
sequences and their ten DIN paths remain disabled.
