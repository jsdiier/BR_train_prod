...
## Experiment: EMA JZ-v3 aligned SID fusion

This branch keeps the EMA batch protocol and adds five candidate SID fields plus
two aligned SID history paths. Five SID embeddings at the same history position
