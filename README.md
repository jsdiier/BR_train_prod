...
## Experiment: EMA RankMixer 3-block replication

This branch uses the EMA JZ-v3 matched-control protocol and changes only the
RankMixer depth from two blocks to three. Token count, token width, slots,
optimizer, loss, EMA and all evaluation windows remain unchanged.
