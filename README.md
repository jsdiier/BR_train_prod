...
`BR_train_prod_ema_new_feature_window_control_tfrecord_fixed/model/checkpoints/20260820/`
and evaluates the same model on both jiazhuo and chenpinyuan-fixed TFRecords
