...
# Common-20260814 checkpoint continuation: jiazhuo
...
training on jiazhuo TFRecords for `20260815-20260820`, then evaluates the local
`20260820` checkpoint on both jiazhuo and chenpinyuan-fixed TFRecords for
`20260821-20260823`.
