...
from module.moe import PLEModel
...
class Model(tf.keras.Model):
    def __init__(self, training=False, pred=False, fid_kv=None, fid_ads_kv=None, l2_reg=0.0001):
        ...
        self.ple = PLEModel(num_experts_shared=4, num_experts_specific=1,
                            expert_units=[512, 256, 128], gate_units=[128],
                            num_tasks=4, num_levels=1, expert_dropout=0.0,
                            use_bn=self.use_bn)
        # 初始化序列网络
