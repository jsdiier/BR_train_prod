...
OUTPUT_DIR=log/ad_segment_ckpt_20260825_20260826_20260828
...
if [[ "${MODE}" == "inspect" ]]; then
    exec "${python}" -u inspect_is_ad_fids.py \
...
"${python}" -u dump_ad_segment_predictions.py \
    --experiment-dir "${BASELINE_DIR}" \
...
"${python}" -u compare_ad_segments.py \
